sap.ui.define(
    ...
    function (ManagedObject, MessageBox, MessageToast) {
      ...
      return ManagedObject.extend(
        "com.sap.internal.digitallab.packagehandling.app.manage.package.ext.component.PickUpDlg",
        {
          ...
          load: function () {
            this._oExtensionAPI
              .loadFragment({
                id: "cdlg",
                name: "com.sap.internal.digitallab.packagehandling.app.manage.package.ext.view.PickUpDlg",
                controller: this,
              })
